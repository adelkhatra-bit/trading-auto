  ...
  const SYSTEM = {
    ...
    files: {
      ...
      agents: [
        ...
        { id: 'ag-data-src', name: 'dataSourceManager.js', path: 'src/agents/dataSourceManager.js', cat: 'Agent', role: 'Abstraction MT5/TradingView/Yahoo sources', functions: 'getPrice(symbol, source), getActiveSources(), getStatus()', status: 'OK' },
        ...
        { id: 'ag-coord', name: 'coordinator.js', path: 'src/agents/coordinator.js', cat: 'Agent', role: 'Cycle agents avec prix réel (MT5→Yahoo fallback)', functions: 'runAgentCycle(priceMap, balance, riskPct)', status: 'OK' },
