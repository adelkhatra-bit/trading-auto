...
function startEntryWatchdog() {
  ...
  var _wdStep = async function() {
    ...
    try {
      ...
      var _lt1 = _bdLive ? String(_bdLive.lectureTech1 || '').toUpperCase() : ''; // M1
      var _lt2 = _bdLive ? String(_bdLive.lectureTech2 || '').toUpperCase() : ''; // M5
      var _lt3 = _bdLive ? String(_bdLive.lectureTech3 || '').toUpperCase() : ''; // M15
      var _lt4 = _bdLive ? String(_bdLive.lectureTech4 || '').toUpperCase() : ''; // H1
